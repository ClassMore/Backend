...
public class QComment extends EntityPathBase<Comment> {
    ...
    private static final long serialVersionUID = 1300774397L;
    ...
    public QComment(Class<? extends Comment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.opinion = inits.isInitialized("opinion") ? new QOpinion(forProperty("opinion"), inits.get("opinion")) : null;
    }
