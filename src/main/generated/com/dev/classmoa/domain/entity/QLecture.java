...
public class QLecture extends EntityPathBase<Lecture> {
    ...
    private static final long serialVersionUID = 403070236L;
    ...
    public final ListPath<Opinion, QOpinion> opinions = this.<Opinion, QOpinion>createList("opinions", Opinion.class, QOpinion.class, PathInits.DIRECT2);
